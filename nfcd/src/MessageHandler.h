...
private:
  ...
  void NotifyMPOSReaderModeEvent(android::Parcel& aParcel, void* aData);
  ...
  bool HandleOpenChannelRequest(android::Parcel& parcel);
  bool HandleTransmitRequest(android::Parcel& parcel);
  bool HandleCloseChannelRequest(android::Parcel& parcel);
  bool HandleGetAtrRequest(android::Parcel& parcel);
  bool HandleResetSecureElementRequest(android::Parcel& parcel);
  bool HandleLsExecuteScriptRequest(android::Parcel& parcel);
  bool HandleLsGetVersionRequest(android::Parcel& parcel);
  bool HandleMPOSReaderModeRequest(android::Parcel& parcel);
  bool HandleNfcSelfTestRequest(android::Parcel& parcel);
  ...
  bool HandleOpenChannelResponse(android::Parcel& aParcel, void* aData);
  bool HandleTransmitResponse(android::Parcel& aParcel, void* aData);
  bool HandleCloseChannelResponse(android::Parcel& aParcel, void* aData);
  bool HandleGetAtrResponse(android::Parcel& aParcel, void* aData);
  bool HandleResetSecureElementResponse(android::Parcel& aParcel, void* aData);
  bool HandleLsExecuteScriptResponse(android::Parcel& aParcel, void* aData);
  bool HandleLsGetVersionResponse(android::Parcel& aParcel, void* aData);
  bool HandleMPOSReaderModeResponse(android::Parcel& aParcel, void* aData);
  bool HandleNfcSelfTestResponse(android::Parcel& aParcel, void* aData);
...
struct LoaderServiceEvent {
  std::string lsExecuteScriptFile;
