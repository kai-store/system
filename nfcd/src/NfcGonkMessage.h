...
typedef enum {
  ...
  /**
   * NFC_REQUEST_OPEN_CHANNEL,
   *
   * Open the channel to the secure element;
   *
   * response is handle id.
   */
  NFC_REQUEST_OPEN_CHANNEL,

  /**
   * NFC_REQUEST_TRANSMIT,
   *
   * Send the APDU command to the secure element;
   *
   * response is APDU response.
   */
  NFC_REQUEST_TRANSMIT,

  /**
   * NFC_REQUEST_CLOSE_CHANNEL,
   *
   * Close the channel to the secure element;
   *
   */
  NFC_REQUEST_CLOSE_CHANNEL,

  /**
   * NFC_REQUEST_RESET_SECUREELEMENT,
   *
   ...
   * NFC_REQUEST_GET_ATR,
   *
   * GetAtr from the connected secure element;
   *
   */
  NFC_REQUEST_GET_ATR,

  NFC_REQUEST_LS_EXECUTE_SCRIPT,
  NFC_REQUEST_LS_GET_VERSION,
  NFC_REQUEST_MPOS_READER_MODE,
  NFC_REQUEST_NFC_SELF_TEST
...
typedef enum {
  ...
  NFC_RESPONSE_OPEN_CHANNEL,

  NFC_RESPONSE_TRANSMIT,

  NFC_RESPONSE_CLOSE_CHANNEL,

  NFC_RESPONSE_RESET_SECUREELEMENT,

  NFC_RESPONSE_GET_ATR,

  NFC_RESPONSE_LS_EXECUTE_SCRIPT,

  NFC_RESPONSE_LS_GET_VERSION,

  NFC_RESPONSE_MPOS_READER_MODE,

  NFC_RESPONSE_NFC_SELF_TEST
...
typedef enum {
  ...
  /**
   * NFC_NOTIFICATION_MPOS_READER_MODE_EVENT
   *
   * To notify a mPOS reader mode event from secure element.
   */
  NFC_NOTIFICATION_MPOS_READER_MODE_EVENT,

  NFC_NOTIFICATION_RF_FIELD_ACTIVATED_EVENT,

  NFC_NOTIFICATION_RF_FIELD_DEACTIVATED_EVENT,

  NFC_NOTIFICATION_LISTEN_MODE_ACTIVATED_EVENT,

  NFC_NOTIFICATION_LISTEN_MODE_DEACTIVATED_EVENT,

  NFC_NOTIFICATION_UNINITIALIZED,

  NFC_NOTIFICATION_ENABLE_TIMEOUT,

  NFC_NOTIFICATION_DISABLE_TIMEOUT
