...
//START-mPOS
void DeviceHost::NotifyMPOSReaderModeEvent(MPOSReaderModeEvent* aEvent)
{
  NfcService::NotifySEMPOSReaderModeEvent(aEvent);
}

void DeviceHost::NotifyMPOSReaderModeErrorEvent(MPOSReaderModeEvent* aEvent)
{
  NfcService::NotifySEMPOSReaderModeErrorEvent(aEvent);
}
//END-mPOS
...
//START-mPOS
void DeviceHost::NotifyListenModeActivated()
{
  NfcService::NotifyListenModeActivated();
}

void DeviceHost::NotifyListenModeDeactivated()
{
  NfcService::NotifyListenModeDeactivated();
}
//END-mPOS
