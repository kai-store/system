...
//START-mPOS
  /**
   * Notifies mPOS reader event received.
   *
   * @param  aEvent Contain transaction aid and payload
   * @return        None.
   */
  void NotifyMPOSReaderModeEvent(MPOSReaderModeEvent* aEvent);

  void NotifyMPOSReaderModeErrorEvent(MPOSReaderModeEvent* aEvent);
//END-mPOS
...
//START-mPOS
  void NotifyListenModeActivated();
  void NotifyListenModeDeactivated();
//END-mPOS
};
